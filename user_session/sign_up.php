...
echo '</div>';
echo '</div>';
echo '<div class="inputRowN">';
echo '<div class="heroClassesHolder">';
echo '<div class="heroClassHolder" onClick="onHeroSelected(1);">';
echo '<img class="heroClassImg"/>';
echo '</div>';
echo '<div class="heroClassHolder" onClick="onHeroSelected(2);">';
echo '<img class="heroClassImg"/>';
echo '</div>';
echo '<div class="heroClassHolder" onClick="onHeroSelected(3);">';
echo '<img class="heroClassImg"/>';
echo '</div>';
echo '<div class="heroClassHolder" onClick="onHeroSelected(4);">';
echo '<img class="heroClassImg"/>';
echo '</div>';
echo '<script type="text/javascript">';
echo 'var heroSelected = 1;';
echo 'function onHeroSelected(heroSelectedN = 1) {';
echo 'heroSelected = heroSelectedN;';
echo '}';
echo '</script>';
echo '</div>';
echo '</div>';
...
echo 'heroSelected: heroSelected';
echo '},';
